...
HISTORICAL_SPILLS_CATALOG = [
    {
        "id": "HIST-MED-2018-04",
        "title": "Cyprus South Coast Heavy Fuel Discharge",
        "date": "2018-09-14",
        "location": "Eastern Mediterranean (Levantine Basin: 33.26° N, 33.05° E)",
        "area_sq_km": 8.10,
        "perimeter_km": 17.9,
        "eccentricity": 0.86,
        "oil_type": "Heavy Fuel Oil (HFO-380)",
        "culprit_mmsi": 212000001,
        "culprit_name": "MEDITERRANEAN TRADER",
        "vector": [0.81, 0.89, 0.86, 0.72, 0.88, 0.95, 0.65, 0.84]
    },
    {
        "id": "HIST-MED-2017-09",
        "title": "Crete-Cyprus Transit Corridor Bilge Sludge",
        "date": "2017-05-22",
        "location": "Levantine Sea (Southern Cyprus Transit)",
        "area_sq_km": 6.40,
        "perimeter_km": 15.2,
        "eccentricity": 0.82,
