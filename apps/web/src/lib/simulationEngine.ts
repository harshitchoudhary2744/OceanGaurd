...
export const CORRIDOR_VESSEL_WAYPOINTS_MAP: Record<number, TimedWaypoint[]> = {
  ...
  500100002: [
      { tMinutes: -360, lon: 31.0, lat: 33.16, heading: 98, speed: 17.6 },
      { tMinutes: -180, lon: 31.75, lat: 33.16, heading: 98, speed: 17.6 },
      { tMinutes: -42, lon: 32.35, lat: 33.16, heading: 98, speed: 17.6 },
      { tMinutes: 0, lon: 32.6, lat: 33.16, heading: 98, speed: 17.6 },
      { tMinutes: 180, lon: 33.35, lat: 33.16, heading: 98, speed: 17.6 },
  ],
  500100003: [
  ...
  500100004: [
      { tMinutes: -360, lon: 31.1, lat: 33.12, heading: 101, speed: 16.9 },
      { tMinutes: -180, lon: 31.85, lat: 33.12, heading: 101, speed: 16.9 },
      { tMinutes: -42, lon: 32.45, lat: 33.12, heading: 101, speed: 16.9 },
      { tMinutes: 0, lon: 32.7, lat: 33.12, heading: 101, speed: 16.9 },
      { tMinutes: 180, lon: 33.45, lat: 33.12, heading: 101, speed: 16.9 },
  ],
  500100005: [
  ...
  500100006: [
      { tMinutes: -360, lon: 30.9, lat: 33.00, heading: 101, speed: 18.4 },
      { tMinutes: -180, lon: 31.7, lat: 33.00, heading: 101, speed: 18.4 },
      { tMinutes: -42, lon: 32.3, lat: 33.00, heading: 101, speed: 18.4 },
      { tMinutes: 0, lon: 32.55, lat: 33.00, heading: 101, speed: 18.4 },
      { tMinutes: 180, lon: 33.3, lat: 33.00, heading: 101, speed: 18.4 },
  ],
  500100007: [
  ...
  500100008: [
      { tMinutes: -360, lon: 31.5, lat: 33.08, heading: 98, speed: 13.1 },
      { tMinutes: -180, lon: 32.1, lat: 33.08, heading: 98, speed: 13.1 },
      { tMinutes: -42, lon: 32.55, lat: 33.08, heading: 98, speed: 13.1 },
      { tMinutes: 0, lon: 32.75, lat: 33.08, heading: 98, speed: 13.1 },
      { tMinutes: 180, lon: 33.35, lat: 33.08, heading: 98, speed: 13.1 },
  ],
  500100009: [
  ...
  500100011: [
      { tMinutes: -360, lon: 31.95, lat: 33.04, heading: 100, speed: 16.4 },
      { tMinutes: -180, lon: 32.65, lat: 33.04, heading: 100, speed: 16.4 },
      { tMinutes: -42, lon: 33.20, lat: 33.04, heading: 100, speed: 16.4 },
      { tMinutes: 0, lon: 33.45, lat: 33.04, heading: 100, speed: 16.4 },
      { tMinutes: 180, lon: 34.20, lat: 33.04, heading: 100, speed: 16.4 },
  ],
  500100012: [
  ...
  500100013: [
      { tMinutes: -360, lon: 30.5, lat: 32.96, heading: 100, speed: 12.2 },
      { tMinutes: -180, lon: 31.15, lat: 32.96, heading: 100, speed: 12.2 },
      { tMinutes: -42, lon: 31.65, lat: 32.96, heading: 100, speed: 12.2 },
      { tMinutes: 0, lon: 31.85, lat: 32.96, heading: 100, speed: 12.2 },
      { tMinutes: 180, lon: 32.5, lat: 32.96, heading: 100, speed: 12.2 },
  ],
  500100014: [
  ...
  500100018: [
      { tMinutes: -360, lon: 32.35, lat: 32.92, heading: 106, speed: 16.2 },
      { tMinutes: -180, lon: 33.05, lat: 32.92, heading: 106, speed: 16.2 },
      { tMinutes: -42, lon: 33.60, lat: 32.92, heading: 106, speed: 16.2 },
      { tMinutes: 0, lon: 33.85, lat: 32.92, heading: 106, speed: 16.2 },
      { tMinutes: 180, lon: 34.40, lat: 32.92, heading: 106, speed: 16.2 },
  ],
  500100019: [
  ...
  500100023: [
      { tMinutes: -360, lon: 31.15, lat: 32.88, heading: 96, speed: 16.5 },
      { tMinutes: -180, lon: 31.85, lat: 32.88, heading: 96, speed: 16.5 },
      { tMinutes: -42, lon: 32.80, lat: 32.88, heading: 96, speed: 16.5 },
      { tMinutes: 0, lon: 33.05, lat: 32.88, heading: 96, speed: 16.5 },
      { tMinutes: 180, lon: 33.80, lat: 32.88, heading: 96, speed: 16.5 },
  ],
  500100024: [
...
export const MUMBAI_VESSEL_WAYPOINTS: { mmsi: number; name: string; isCulprit?: boolean; linkedSpillId?: string; waypoints: TimedWaypoint[] }[] = [
  {
    ...
    waypoints: [
      { tMinutes: -360, lon: 32.40, lat: 33.23, heading: 95, speed: 13.8 },
      ...
      { tMinutes: -15, lon: 33.085, lat: 33.27, heading: 95, speed: 6.2 },
  ...
  },
  {
    ...
    name: "LEVANT STAR",
    waypoints: [
      { tMinutes: -360, lon: 33.25, lat: 32.40, heading: 15, speed: 14.2 },
      { tMinutes: -180, lon: 33.32, lat: 32.78, heading: 15, speed: 14.2 },
      { tMinutes: -42, lon: 33.38, lat: 33.12, heading: 15, speed: 14.2 },
      { tMinutes: 0, lon: 33.43, lat: 33.40, heading: 15, speed: 14.2 },
      { tMinutes: 180, lon: 33.52, lat: 33.95, heading: 15, speed: 14.2 },
    ],
  },
  {
    mmsi: 212000003,
    name: "AEGEAN VOYAGER",
    waypoints: [
      { tMinutes: -360, lon: 32.50, lat: 33.45, heading: 98, speed: 12.5 },
      { tMinutes: -180, lon: 32.85, lat: 33.43, heading: 98, speed: 12.5 },
      { tMinutes: -42, lon: 33.15, lat: 33.41, heading: 98, speed: 12.5 },
      { tMinutes: 0, lon: 33.35, lat: 33.39, heading: 98, speed: 12.5 },
      { tMinutes: 180, lon: 33.70, lat: 33.36, heading: 98, speed: 12.5 },
    ],
  },
  {
    mmsi: 212000004,
  ...
  },
  {
    ...
    waypoints: [
      { tMinutes: -360, lon: 33.02, lat: 34.50, heading: 175, speed: 12.0 },
      { tMinutes: -180, lon: 33.03, lat: 34.35, heading: 175, speed: 14.0 },
      { tMinutes: -42, lon: 33.04, lat: 34.15, heading: 175, speed: 16.0 },
      { tMinutes: -15, lon: 33.048, lat: 33.65, heading: 175, speed: 24.0 },
      { tMinutes: 0, lon: 33.055, lat: 33.310, heading: 175, speed: 8.0 },
      { tMinutes: 180, lon: 33.060, lat: 33.295, heading: 135, speed: 4.5 },
    ],
  },
