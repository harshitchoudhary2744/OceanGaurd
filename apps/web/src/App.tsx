  ...
  const handleInferenceResult = (res: SARInferenceResponse) => {
    ...
    if (res?.spill) {
      ...
      registerCustomSpillIncident({
        ...
        segmentation_iou_score: res.metrics?.segmentation_iou_score ?? res.spill.segmentation_iou_score,
        max_probability: res.metrics?.max_probability ?? res.spill.max_probability,
        oil_likelihood_score: res.metrics?.oil_likelihood_score ?? res.spill.oil_likelihood_score,
        damping_ratio_db: res.metrics?.damping_ratio_db ?? res.spill.damping_ratio_db,
        lookalike_score: res.metrics?.lookalike_score ?? res.spill.lookalike_score,
      ...
      const newFeature: SpillGeoFeature = {
        ...
        properties: {
          ...
          segmentation_iou_score: res.metrics?.segmentation_iou_score ?? res.spill.segmentation_iou_score ?? undefined,
          max_probability: res.metrics?.max_probability ?? res.spill.max_probability ?? undefined,
